...
function AdminProfiles() {
  ...
  const handlePromote = async (email) => {
    ...
    try {
      const response = await fetch('https://finalbackend-8.onrender.com/api/promote-member', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleDePromote = async (email) => {
    try {
      const response = await fetch('https://finalbackend-8.onrender.com/api/depromote-lead', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
